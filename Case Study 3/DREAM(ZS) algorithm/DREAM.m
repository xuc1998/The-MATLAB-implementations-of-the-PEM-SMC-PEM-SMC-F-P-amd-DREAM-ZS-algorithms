...
Func_name = 'CoLM';
observed_LE=importdata('./Observations/LE_verify.txt');   % the filepath of the site observation of LE
observed_NEE=importdata('./Observations/NEE_verify.txt'); % the filepath of the site observation of NEE
observed_RSM=importdata('./Observations/RSM_verify.txt'); % the filepath of the site observation of RSM
